...
class LightState extends State<Light>{
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<LightModel>> devices = LightController.getLightsFromMonday(context);

    /*
    AppBar
     */
    Widget appBar = new AppBar(
      title: new Text(R.of(context).lightTitleBar),
    ...
    Widget body = FutureBuilder(
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          List<LightModel> lights = snapshot.data;
   ...
   */
  Widget buildListItem(OnOffButton switchButton, LightModel light,
      BuildContext context) {
    String name = light.name;
    Widget popUpMenu = _buildPopUpMenu(context, light);
    return new Card(
   ...
   */
  List<Widget> buildList(List<LightModel> devices, BuildContext context){
   ...
   */
  Widget _buildPopUpMenu(BuildContext context, LightModel device) {
