<?php
    class MeasureHourlyAVG{
        
        // database connection and table name
        private $conn;
        private $table_name = "MeasureHourlyAVG";
        ...
        // sum measures of type $type from all devices for each hour
        function sumOfType($type){
            
            // select all query
            $query = "SELECT date, SUM(value) as hourlyConsumptionTotal
                    FROM (
                        SELECT m1.*
